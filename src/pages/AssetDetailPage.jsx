...
import { canManageCatalogue, ensureMockUser, formatRoleLabel } from '../utils/mockAuth';
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="rounded-3xl border border-amber-200 bg-amber-50 p-8">
          <h1 className="text-2xl font-semibold text-amber-900">Catalogue access is restricted</h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-amber-800">
            This detail page currently allows only ADMIN and ASSET_MANAGER access. Current mock role
            is {formatRoleLabel(currentUser.userRole)}.
          </p>
          <button
            type="button"
            onClick={() => navigate('/assets')}
            className="mt-6 rounded-2xl bg-amber-900 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-amber-950"
          >
            Back to catalogue
          </button>
        </div>
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 text-sm leading-6 text-gray-600">
              ...
              currently assigned to {asset.assetType?.name || 'an unknown type'} and managed under
            ...
            <div className="rounded-3xl border border-gray-200 bg-white shadow-sm">
              ...
              {!asset.media?.length ? (
                <div className="p-12 text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Add photos or videos when updating the asset record to build visual context.
                  </p>
                </div>
              ) : (
